public class Taula {
    private Filosof[] comensals; // Array de filòsofs
    private Forquilla[] forquilles; // Array de forquilles
    ...
    public void showTaula() {
        for (int i = 0; i < comensals.length; i++) {
            System.out.println("Comensal: fil" + i + " esq:" + forquilles[i].getNumero() + 
    ...
    public static void main(String[] args) {
        int numFilosofs = 5; // Nombre de filòsofs
